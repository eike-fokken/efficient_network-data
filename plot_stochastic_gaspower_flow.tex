...
\begin{tikzpicture}
  \begin{axis}[
    ...
    ylabel={\large q(\si{\meter \cubed \per \second})},
    table/col sep=comma,
    legend pos=north east,legend cell align=left]

    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_mean.csv}\mean
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_sigma.csv}\sigma
