...
\begin{tikzpicture}
  \begin{axis}[
    ...
    ylabel={\large flow(\si{\meter \cubed \per \second})},
    x filter/.code={\pgfmathparse{#1/3600}\pgfmathresult},
    ymin=18,
    ymax=30,
    table/col sep=comma,
    legend pos=north west,legend cell align=left]
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_three_high.csv}\threehigh
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_two_high.csv}\twohigh
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_one_high.csv}\onehigh
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_median.csv}\median
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_one_low.csv}\onelow
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_two_low.csv}\twolow
    \pgfplotstableread[skip first n = 1 ]{./p_br71_flow_q_three_low.csv}\threelow
    ...
    % \addlegendentry{\tiny Deterministic flow}
